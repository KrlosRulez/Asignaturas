window.onload = function () {
    ...
    for (let libro of libros) {
        ...
        li_author.innerHTML = "<b>Author:</b> " + libro.author;

        let li_title = document.createElement("li");

        li_title.innerHTML = "<b>Title:</b> " + libro.title;

        let li_read = document.createElement("li");

        li_read.innerHTML = "<b>¿Read?:</b> " + libro.read;

        let li_year = document.createElement("li");

        li_year.innerHTML = "<b>Year:</b> " + libro.year;
